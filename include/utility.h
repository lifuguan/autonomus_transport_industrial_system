 ...
 * @LastEditTime: 2020-02-21 19:51:35
...
namespace autonomus_transport_industrial_system
{
class Utility
{
public:
     ...
     * @param {type} 
     * @note: roll代表绕z轴旋转，pitch代表绕x轴旋转，yaw代表绕y轴旋转
     * @return: RPY[rall, pitch, yaw, \t]
     */
...
double autonomus_transport_industrial_system::Utility::GetEuclideanDistance(
...
double * autonomus_transport_industrial_system::Utility::GetYawFromOrientation(
